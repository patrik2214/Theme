            ...
            if($imgload==true){
                if($name1==true and  $lastname1==true and $username1==true and  $email1==true and $password1==true and $cpassword1==true){
                    if($password==$cpassword){
                        ...
                        $a=$cnx->prepare("INSERT INTO USUARIO(idusuario,nombre,apellido,nombreusuario,correo,fecha_registro,password,idTIPOUSUARIO,foto,estado) 
                        VALUES(:idusuario,:nombre,:apellido,:nombreusuario,:correo,now(),:password,:tipousuario,:foto,:estado)");
