...
if($imgload==true){
    if ($name1==true and  $lastname1==true and $username1==true and  $email1==true){
        ...
        $c=$cnx->prepare("UPDATE USUARIO SET nombre=:nombre,apellido=:apellido,nombreusuario=:nombreusuario,correo=:correo,foto=:foto WHERE idusuario=:idusuario");
