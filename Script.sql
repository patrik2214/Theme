...
CREATE TABLE IF NOT EXISTS `mydb`.`USUARIO` (
  ...
  `TIPOUSUARIO_idTIPOUSUARIO` BIGINT NOT NULL,
...
CREATE TABLE IF NOT EXISTS `mydb`.`TIPOREPOSITORIO` (
  ...
  UNIQUE INDEX `idTIPOREPOSITORIO_UNIQUE` (`idTIPOREPOSITORIO` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`REPOSITORIO` (
  ...
  UNIQUE INDEX `idREPOSITORIO_UNIQUE` (`idREPOSITORIO` ASC) VISIBLE,
  INDEX `fk_REPOSITORIO_TIPOREPOSITORIO1_idx` (`TIPOREPOSITORIO_idTIPOREPOSITORIO` ASC) VISIBLE,
  UNIQUE INDEX `nombre_UNIQUE` (`nombre` ASC) VISIBLE,
  INDEX `fk_REPOSITORIO_GENERO1_idx` (`GENERO_idGENERO` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`TIPODESARROLLADOR` (
  ...
  UNIQUE INDEX `idTIPODESARROLLADOR_UNIQUE` (`idTIPODESARROLLADOR` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`DESARROLLADOR` (
  ...
  INDEX `fk_DESARROLLADORES_USUARIO1_idx` (`USUARIO_idUSUARIO` ASC) VISIBLE,
  INDEX `fk_DESARROLLADORES_REPOSITORIO1_idx` (`REPOSITORIO_idREPOSITORIO` ASC) VISIBLE,
  ...
  UNIQUE INDEX `REPOSITORIO_idREPOSITORIO_UNIQUE` (`REPOSITORIO_idREPOSITORIO` ASC) VISIBLE,
  INDEX `fk_DESARROLLADOR_TIPODESARROLLADOR1_idx` (`TIPODESARROLLADOR_idTIPODESARROLLADOR` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`PROYECTO` (
  ...
  INDEX `fk_PROYECTO_REPOSITORIO1_idx` (`REPOSITORIO_idREPOSITORIO` ASC, `REPOSITORIO_TIPOREPOSITORIO_idTIPOREPOSITORIO` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`PISTAS` (
  ...
  UNIQUE INDEX `idPISTAS_UNIQUE` (`idPISTAS` ASC) VISIBLE,
  INDEX `fk_PISTAS_PROYECTO1_idx` (`PROYECTO_idPROYECTO` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`PARTITURAS` (
  ...
  UNIQUE INDEX `idPARTITURAS_UNIQUE` (`idPARTITURAS` ASC) VISIBLE,
  INDEX `fk_PARTITURAS_PROYECTO1_idx` (`PROYECTO_idPROYECTO` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`DETALLE` (
  ...
  INDEX `fk_DETALLE_VENTA1_idx` (`VENTA_idVENTA` ASC) VISIBLE,
  INDEX `fk_DETALLE_PROYECTO1_idx` (`PROYECTO_idPROYECTO` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`TIPOPAGO` (
  ...
  UNIQUE INDEX `idTIPOPAGO_UNIQUE` (`idTIPOPAGO` ASC) VISIBLE)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`PAGO` (
  ...
  INDEX `fk_PAGO_TIPOPAGO1_idx` (`TIPOPAGO_idTIPOPAGO` ASC) VISIBLE,
